...
```Groovy
compile 'com.google.api:gax:1.58.4',
  'com.google.api:gax-grpc:1.58.4'
```

If you are using SBT, add this to your dependencies

```Scala
libraryDependencies += "com.google.api" % "gax" % "1.58.4"
libraryDependencies += "com.google.api" % "gax-grpc" % "1.58.4"
```
