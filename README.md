...
```Groovy
compile 'com.google.api:gax:1.50.1',
  'com.google.api:gax-grpc:1.50.1'
```

If you are using SBT, add this to your dependencies

```Scala
libraryDependencies += "com.google.api" % "gax" % "1.50.1"
libraryDependencies += "com.google.api" % "gax-grpc" % "1.50.1"
```
