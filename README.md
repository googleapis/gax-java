...
```Groovy
compile 'com.google.api:gax:1.7.1',
  'com.google.api:gax-grpc:0.24.1'
```

If you are using SBT, add this to your dependencies

```Scala
libraryDependencies += "com.google.api" % "gax" % "1.7.1"
libraryDependencies += "com.google.api" % "gax-grpc" % "0.24.1"
```
